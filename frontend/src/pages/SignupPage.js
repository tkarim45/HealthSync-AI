      ...
      <div className="flex-1 flex items-center justify-center py-12">
        <motion.div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full" initial="hidden" animate="visible" variants={formVariants}>
          <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">
            Sign Up for <span className="text-teal-500">HealthSync AI</span>
          </h1>
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:border-teal-500" placeholder="e.g., john.doe@example.com" required disabled={loading} />
            </div>
            <div className="mb-6">
